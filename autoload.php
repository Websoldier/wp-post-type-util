...
spl_autoload_register(
	function ( $class_name ) {
		...
		$class_dir = realpath( plugin_dir_path( __FILE__ ) ) . DIRECTORY_SEPARATOR . 'includes' . DIRECTORY_SEPARATOR;
		...
		// Class base name (without namespace).
		$class_basename = &$class_parts[ count( $class_parts ) ];
		// Filename like a WordPress.
